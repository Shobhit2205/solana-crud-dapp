...
export function SolanacruddappList() {
  const { accounts, getProgramAccount } = useSolanacruddappProgram()
      ...
      {accounts.isLoading ? (
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {accounts.data?.map((account) => (
            <SolanacruddappCard key={account.publicKey.toString()} account={account.publicKey} />
          ))}
        </div>
      ) : (
